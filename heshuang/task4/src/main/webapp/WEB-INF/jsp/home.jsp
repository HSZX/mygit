...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="box1">
                        <div class="row1"><img src="../../static/img/1.jpg"></div>
                        <p class="row2">高效</p>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="box1">
                        <div class="row1"><img src="../../static/img/2.jpg"></div>
                        <p class="row2">规范</p>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="box1">
                        <div class="row1"><img src="../../static/img/3.jpg"></div>
                        <p class="row2">人脉</p>
                        <p class="row3"></picture>同班好友，同院学长，技术大师，入学就混入职脉圈，为以后铺平道路</p>
                    </div>
                </div>
                <div class="box col-md-3 col-sm-12 col-xs-12">
                    <div class="number"><img src="../../static/img/4.png">${i}</div>
                    <p class="sum">累计在线学习人数</p>
                    <div class="number"><img src="../../static/img/4.png">${j}</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="quarter col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="icon"><img src="../../static/img/5.jpg"></div>
                    </div>
                    <div class="quarter col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <c:forEach items="${list}" var="students">
                    <c:if test="${students.id == 1}">
                <div class="block">
                    <div class="char"><img src="../../static/img/6.jpg"></div>
                    <div class="adviser">技术顾问:${students.name}</div>
                    <div class="intro">${students.stu_introduction}</div>
                </div>
            </div>
                    </c:if>
            </c:forEach>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <c:forEach items="${list}" var="students">
                    <c:if test="${students.id == 2}">
                <div class="block">
                    <div class="char"><img src="../../static/img/7.jpg"></div>
                    <div class="adviser">技术顾问：${students.name}</div>
                    <div class="intro">${students.stu_introduction}</div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <c:forEach items="${list}" var="students">
                    <c:if test="${students.id == 3}">
                <div class="block">
                    <div class="char"><img src="../../static/img/8.jpg"></div>
                    <div class="adviser">技术顾问：${students.name}</div>
                    <div class="intro">${students.stu_introduction}</div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <c:forEach items="${list}" var="students">
                     <c:if test="${students.id == 4}">
                <div class="block">
                    <div class="char"><img src="../../static/img/9.jpg"></div>
                    <div class="adviser">技术顾问：${students.name}</div>
                    <div class="intro">${students.stu_introduction}</div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="picture col-md-2 col-sm-12 col-xs-12"><img src="../../static/img/10.jpg"></div>
            <div class="picture col-md-2 col-sm-12 col-xs-12"><img src="../../static/img/11.jpg"></div>
            <div class="picture col-md-2 col-sm-12 col-xs-12"><img src="../../static/img/12.jpg"></div>
            <div class="picture col-md-2 col-sm-12 col-xs-12"><img src="../../static/img/13.jpg"></div>
            <div class="picture col-md-2 col-sm-12 col-xs-12"><img src="../../static/img/14.jpg"></div>
        </div>
    </div>
    ...
    <div class="section5">
        <div class="container">
            ...
            <div class="row">
                ...
                </div><div class="link col-md-1 col-sm-2 col-xs-6">
                <ul>
                    <li>
                        <a href="#">手机软件</a>
                        <div class="extro-info3"></div>
